...
#include "01_Item/01_Consume/00_Potion/HPPotionActor.h"

void AHPPotionActor::InitItemInformation()
{
	...
	if (GenericItemInformation.P_ItemInfo.IsValid()) {
		...
		args.Emplace(FStringFormatArg(FString::FormatAsNumber(Potion->RecoverHP)));
